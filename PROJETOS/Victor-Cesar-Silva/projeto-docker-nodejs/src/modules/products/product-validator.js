...
function parseMoney(value, field) {
  ...
  // isFinite aceita centavos e rejeita NaN / Infinity
...
export function validateProductInput(input) {
  ...
  // SKU sempre em maiusculas, para a regra de unicidade funcionar
  ...
  // Regra de negocio: nao vendemos com prejuizo
  ...
  // O campo pode chegar vazio de tres formas: undefined, null ou ""
