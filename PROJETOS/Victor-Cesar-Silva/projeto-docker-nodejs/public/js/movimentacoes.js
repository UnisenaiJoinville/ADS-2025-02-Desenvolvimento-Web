...
// Estado da tela: a lista carregada e a aba ativa
let products = [];
let activeFilter = "";
...
async function loadProducts() {
  // Guardamos a lista para consultar o saldo sem ir a API
...
function updateStockHint() {
  // O value do select e string: sem Number() o find nunca acharia o produto
...
form.addEventListener("submit", async (event) => {
  ...
  const payload = {
    ...
    // Os dois radios tem name="type": o FormData devolve o marcado
    type: data.get("type"),
