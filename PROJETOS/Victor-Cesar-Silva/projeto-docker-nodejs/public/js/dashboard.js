...
// Guardamos as referencias uma vez, no topo
...
// Componente: recebe dados, devolve HTML
...
function renderCards(totals) {
  cardsContainer.innerHTML = [
    ...
    card({
      ...
      // A bolinha fica vermelha so quando ha produtos em falta
...
function renderByCategory(rows) {
  ...
  // O ", 1" evita divisao por zero se todos os valores forem zero
...
function renderRecent(rows) {
  ...
  recentContainer.innerHTML = rows
    .map((row) => {
      // Uma variavel controla cor, texto e sinal
...
// Area em branco parece bug; mensagem explicita informa o usuario
