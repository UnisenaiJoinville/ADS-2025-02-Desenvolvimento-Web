...
// Intl cuida de simbolo, separador de milhar e casas decimais
...
export function formatDateTime(value) {
  ...
  // O MySQL devolve "2026-09-09 00:03:42"; o padrao ISO usa "T"
...
// Evita injecao de HTML (XSS) ao montar tabelas com dados do banco.
// O & vem primeiro, senao estragaria as substituicoes seguintes.
...
// Menu gerado por JS: acrescentar uma tela mexe em um arquivo so
...
export function toast(message, variant = "success") {
  ...
  // Espera o navegador desenhar antes de animar a entrada
