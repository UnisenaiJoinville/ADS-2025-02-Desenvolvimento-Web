...
async function request(path, options = {}) {
  ...
  // DELETE responde 204: nao ha corpo para ler
  ...
  // ATENCAO: fetch NAO lança erro em 404/500. Precisamos checar response.ok.
  if (!response.ok) {
...
export const api = {
  ...
  listProducts: (filters = {}) => {
    // URLSearchParams escapa caracteres especiais por nos
