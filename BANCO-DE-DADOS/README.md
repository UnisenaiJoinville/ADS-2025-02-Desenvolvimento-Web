...
3. Procure, aqui dentro de `BANCO-DE-DADOS/`, a **subpasta com o seu nome** (ex.: `BANCO-DE-DADOS/Ana-Carolina-da-Silveira/`) e coloque os arquivos da sua atividade dentro dela.
