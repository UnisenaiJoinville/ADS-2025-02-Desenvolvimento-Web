...
Pasta destinada aos projetos de Banco de Dados dos alunos.
...
2. Procure, aqui dentro de `BANCO-DE-DADOS/`, a **subpasta com o seu nome** (ex.: `BANCO-DE-DADOS/Ana-Carolina-da-Silveira/`) e coloque os arquivos da sua atividade dentro dela. Não crie nova pasta de aluno na `main`, mas pode criar subpastas dentro dela se precisar.
...
git add "BANCO-DE-DADOS/<SUA-SUBPASTA>"
git commit -m "Envio da atividade de Banco de Dados - <seu nome>"
