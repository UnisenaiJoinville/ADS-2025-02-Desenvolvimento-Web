...
> **Atividade em equipe:** o diagnóstico do código propositalmente ruim (item 26.1) foi conduzido em equipe por **Danillo de Souza Koch** e **Mauricio da Rosa Ventura**, conforme o enunciado do módulo. A refatoração (26.2) e o desafio de agendamento (26.3) seguem a mesma análise combinada.

O projeto cobre três entregas em sequência:

1. **26.1 — Diagnóstico de código**: análise em equipe do código propositalmente ruim fornecido pelo professor (documentada em PDF separado, não neste código).
