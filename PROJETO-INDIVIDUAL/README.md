...
2. Procure, aqui dentro de `PROJETO-INDIVIDUAL/`, a **subpasta com o seu nome** (ex.: `PROJETO-INDIVIDUAL/Ana-Carolina-da-Silveira/`) e coloque os arquivos do seu projeto dentro dela. Não crie nova pasta de aluno na `main`, mas pode criar subpastas dentro dela se precisar.
